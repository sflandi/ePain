...
<!-- <body style="font-family: 'Helvetica', sans-serif;"> -->
    ...
    <div class="container" >
        ...
        <div class="row" style="margin-top:15%;">
            <div class="col-sm-4">
                <!-- <button type="submit" class="btn btn-block btn-primary button">EMERGENCY</button> -->
                <!-- <a href="emergencyPlan.php?idedit=".$nrpID." class="fancy-button bg-gradient1"><span>EMERGENCY</span></a> -->
                <?php
                    echo '<a href="emergencyPlan.php?idedit='.$nrpID.'&age='.$usia.'&days='.$hariUsia.'&plan=emergency" class="fancy-button bg-gradient1"><span>EMERGENCY</span></a>';
                ?>
            </div>
            <div class="col-sm-4">
                <?php
                    echo '<a href="rawatInapPlan.php?idedit='.$nrpID.'&age='.$usia.'&days='.$hariUsia.'&plan=rawatInap" class="fancy-button bg-gradient1"><span>RAWAT INAP</span></a>';
                ?>
                <!-- <a href="rawatInapPlan.php" class="fancy-button bg-gradient1"><span>RAWAT INAP</span></a> -->
            </div>
            <div class="col-sm-4">
                <?php
                    echo '<a href="rawatJalanPlan.php?idedit='.$nrpID.'&age='.$usia.'&days='.$hariUsia.'&plan=rawatJalan" class="fancy-button bg-gradient1"><span>RAWAT JALAN</span></a>';
                ?>
                <!-- <a href="rawatJalanPlan.php" class="fancy-button bg-gradient1"><span>RAWAT JALAN</span></a> -->
            </div>
        </div>
        <div class="row" style="margin-top:16%">
            <div class="col-sm-2">
            <?php
                echo '<a href="formDetailsPatient.php?idedit='.$nrpID.'" class="btn btn-primary btn-block button1"><i class="fas fa-chevron-left"></i><span>KEMBALI</span></a>';
            ?>
            </div>
