...
<body style="font-family: 'Montserrat', sans-serif; background-image: url('img/bg2.jpg'); background-repeat: no-repeat; background-position: center; background-size: cover;">
    ...
    <div class="animate-bottom" >
        <form action="insertFlacc.php" method="post">
        ...
        <div class="form-group">
                <div class="row">
                    ...
                    <div class="col-sm-2">
                        ...
                        <?php
                            echo '<a href="emergencyBatita.php?idedit='.$nrpID.'&age='.$usia.'&days='.$hariUsia.'" class="btn btn-primary btn-block button1"><span>KELUAR</span></a>';
