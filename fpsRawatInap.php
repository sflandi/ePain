...
<body style="font-family: 'Montserrat', sans-serif; background-image: url('img/bg2.jpg'); background-repeat: no-repeat; background-position: center; background-size: cover;">
    ...
    <div class="animate-bottom" >
        <form action="insertFpsRawatInap.php" method="post">
            ...
            <div class="form-group">
                <div class="row">
                    ...
                    <div class="col-sm-2">
                        <!-- <a href="rawatInapAdult.php" class="btn btn-primary btn-block button1">KELUAR</a> -->
                        <?php
                            echo '<a href="rawatInapKids.php?idedit='.$nrpID.'&age='.$usia.'&days='.$hariUsia.'&plan='.$planRawatInap.'" class="btn btn-primary btn-block button1"><span>KELUAR</span></a>';
                        ?>
                    </div>
                    <div class="col-sm-2">
