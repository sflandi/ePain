    ...
    if(isset($_SESSION['username'])){
        ...
        // $selected = mysqli_select_db($myDB, $dbhandle);
            ...
            if(isset($nrpID)){
                ...
                echo ("<script LANGUAGE='JavaScript'> window.alert('Data Sudah Tersimpan'); window.location.href='emergencyBatita.php?idedit=$nrpID&age=$usia&days=$hariUsia&plan=emergency'; </script>");
