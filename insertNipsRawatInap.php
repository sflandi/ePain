    ...
    if(isset($_SESSION['username'])){
        ...
        or die ("koneksi gagal");
            ...
            if(isset($nrpID)){
                ...
                $sql1 = mysqli_query($koneksi,"INSERT INTO data_plan (nrpID, nrs, fps, flacc, nips, cpot, cfs, ruangan, waktu) VALUES ('$nrpID', NULL, NULL, NULL, $value, NULL,NULL,'$planRawatInap', NOW() )");
