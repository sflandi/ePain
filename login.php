<?php 
    ...
    {
      header("location: formEmanagement.php");
    }
    else
    {
?> 
...
<html lang="en">
    ...
    <meta name="generator" content="Bootply" />
		...
		<title>Login Nurse | E-Pain</title>
	...
	<!-- <body> -->
	<body onload="myFunction()" style="font-family: 'Montserrat', sans-serif;margin:0;background-color: #E0E0E0; background-image: url('img/bg1.jpg'); background-repeat: no-repeat; background-position: center; background-size: cover; ">
			...
			<div class="d-flex justify-content-center h-100">
				<div class="card">
					<div class="card-header">
						...
						<!-- <center><h3>E-Pain</h3></center> -->
					</div>
					<div class="card-body">
						<form action="cek-login2.php" method="post">
							...
							<div class="form-group">
								...
								<!-- <center><button type="submit" class="btn btn-primary btn-lg btn-block" name="login">Login</button></center> -->
