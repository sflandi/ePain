...
<!-- <body style="font-family: 'Helvetica', sans-serif;"> -->
    ...
    <div class="row">
        ...
        <div class="row" style="margin-top:15%;">
            <div class="col-sm-4">
                <?php
                    echo '<a href="flaccRawatInap.php?idedit='.$nrpID.'&age='.$usia.'&days='.$hariUsia.'&plan='.$planRawatInap.'" class="fancy-button bg-gradient1"><span>FLACC</span></a>';
                ?>
            </div>
            <div class="col-sm-4">
                <?php
                    echo '<a href="cpotRawatInapBatita.php?idedit='.$nrpID.'&age='.$usia.'&days='.$hariUsia.'&plan='.$planRawatInap.'" class="fancy-button bg-gradient1"><span>CPOT</span></a>';
                ?>
            </div>
            <div class="col-sm-4">
                <?php
                    echo '<a href="cfsRawatInap.php?idedit='.$nrpID.'&age='.$usia.'&days='.$hariUsia.'&plan='.$planRawatInap.'" class="fancy-button bg-gradient1"><span>CFS</span></a>';
                ?>
            </div>
        </div>
        ...
        <div class="row" style="margin-top:16%">
            ...
            <div class="col-sm-2">
            <?php
                echo '<a href="continueTableV3.php?idedit='.$nrpID.'&age='.$usia.'&days='.$hariUsia.'&plan='.$planRawatInap.'" class="btn btn-primary btn-block button1"><span>LANJUTKAN</span></a>';
            ?>
            </div>
        </div>
        </div>
