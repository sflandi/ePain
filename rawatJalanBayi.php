...
<!-- <body style="font-family: 'Helvetica', sans-serif;"> -->
    ...
    <div class="row">
        ...
        <div class="row" style="margin-top:15%;">
            <div class="col-sm-4">
                <?php
                    echo '<a href="nipsRawatJalan.php?idedit='.$nrpID.'&age='.$usia.'&days='.$hariUsia.'&plan='.$planRawatJalan.'" class="fancy-button bg-gradient1"><span>NIPS</span></a>';
                ?>
            </div>
            <div class="col-sm-4">
                <?php
                    echo '<a href="cpotRawatJalanBayi.php?idedit='.$nrpID.'&age='.$usia.'&days='.$hariUsia.'&plan='.$planRawatJalan.'" class="fancy-button bg-gradient1"><span>CPOT</span></a>';
                ?>
            </div>
            <div class="col-sm-4">
                <?php
        ...
        <div class="row" style="margin-top:16%">
            ...
            <div class="col-sm-2">
            <?php
                echo '<a href="continueTableV4.php?idedit='.$nrpID.'&age='.$usia.'&days='.$hariUsia.'&plan='.$planRawatJalan.'" class="btn btn-primary btn-block button1"><span>LANJUTKAN</span></a>';
            ?>
            </div>
        </div>
        </div>
