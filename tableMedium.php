...
<!-- <body class="d-flex flex-column h-100"> -->
    ...
    <div class="container" style="overflow:hidden;">
        ...
        <center><h5>SKALA NYERI SEDANG</h5></center>
            <div class="row" style="margin-top:5%;">
            <form action="insertTableMed.php" method="post">
                <input type="text" name="skalaNyeri" id="skalaNyeri" value="Sedang" hidden>
                ...
                <table class="table table-hover order-table">
                    ...
                    <tbody>
                        <tr>
                            <td>Kaji ulang nyeri sesuai kategori: PQRST</td>
                            <td><textarea name="implementasiMed0" id="implementasiMed0" cols="30" rows="7"></textarea> </td>
                            <td><textarea name="evaluasiMed0" id="evaluasiMed0" cols="30" rows="7"></textarea> </td>
                        </tr>
                        <tr>
                            <td>Kaji riwayat nyeri pasien</td>
                            <td><textarea name="implementasiMed1" id="implementasiMed1" cols="30" rows="7"></textarea> </td>
                            <td><textarea name="evaluasiMed1" id="evaluasiMed1" cols="30" rows="7"></textarea> </td>
                        </tr>
                        <tr>
                            <td>Beritahu pasien untuk melaporkan nyeri dengan segera</td>
                            <td><textarea name="implementasiMed2" id="implementasiMed2" cols="30" rows="7"></textarea> </td>
                            <td><textarea name="evaluasiMed2" id="evaluasiMed2" cols="30" rows="7"></textarea> </td>
                        </tr>
                        <tr>
                            <td>Observasi TTV sebelum dan sesudah pemberian obat narkotik</td>
                            <td><textarea name="implementasiMed3" id="implementasiMed3" cols="30" rows="7"></textarea> </td>
                            <td><textarea name="evaluasiMed3" id="evaluasiMed3" cols="30" rows="7"></textarea> </td>
                        </tr>
                        <tr>
                            <td>Observasi nyeri pasien setelah 30 menit pemberian obat nyeri <i>(pain killer)</i></td>
                            <td><textarea name="implementasiMed4" id="implementasiMed4" cols="30" rows="7"></textarea> </td>
                            <td><textarea name="evaluasiMed4" id="evaluasiMed4" cols="30" rows="7"></textarea> </td>
                        </tr>
                        <tr>
                            <td>Lakukan assesment ulang tiap 4-6 jam setelah pemberian obat nyeri</td>
                            <td><textarea name="implementasiMed5" id="implementasiMed5" cols="30" rows="7"></textarea> </td>
                            <td><textarea name="evaluasiMed5" id="evaluasiMed5" cols="30" rows="7"></textarea> </td>
                        </tr>
                        <tr>
                            <td>Libatkan support keluarga dalam manajemen nyeri</td>
                            <td><textarea name="implementasiMed6" id="implementasiMed6" cols="30" rows="7"></textarea> </td>
                            <td><textarea name="evaluasiMed6" id="evaluasiMed6" cols="30" rows="7"></textarea> </td>
                        </tr>
                        <tr>
                            <td>Pertahankan lingkungan yang tenang dan suasana yang nyaman</td>
                            <td><textarea name="implementasiMed7" id="implementasiMed7" cols="30" rows="7"></textarea> </td>
                            <td><textarea name="evaluasiMed7" id="evaluasiMed7" cols="30" rows="7"></textarea> </td>
                        </tr>
                        <tr>
                            <td><b>KOLABORASI</b> </td>
                        </tr>
                        <tr>
                            <td>Pertimbangkan pemberian analgetik, misalnya NSAID dan Opioid</td>
                            <td><textarea name="implementasiMed8" id="implementasiMed8" cols="30" rows="7"></textarea> </td>
                            <td><textarea name="evaluasiMed8" id="evaluasiMed8" cols="30" rows="7"></textarea> </td>
                        </tr>
                    </tbody>
                </table>
